        ...
        <div class="row login-container">
            ...
            <div class="col-md-6">
                <form action="#" method="POST" class="login-form">
                    <h3 class="mb-4 text-center"><b>Login Kost-In</b></h3>
                    <div class="mb-3">
                    ...
                    <p>Belum punya akun Kost-In? <a href="#" data-bs-toggle="modal" data-bs-target="#registerModal" style="color: #EDD9A3;">Daftar Disini</a></p>
                   <!-- Modal Daftar -->
                    <div class="modal fade" id="registerModal" tabindex="-1" aria-labelledby="registerModalLabel" aria-hidden="true">
                        <div class="modal-dialog modal-dialog-centered"> <!-- Menambahkan modal-dialog-centered -->
                            <div class="modal-content">
                                <div class="modal-header">
                                    <h5 style="color: black" class="modal-title" id="registerModalLabel">Daftar Kost-In</h5>
                                    <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                                </div>
                                <div class="modal-body">
                                    <!-- Tombol Daftar sebagai Pencari Kost -->
                                    <a href="/register/pencari" class="btn daftar-pencari w-100 mb-3">Daftar sebagai Pencari Kost</a>
                                    <!-- Tombol Daftar sebagai Pemilik Kost -->
                                    <a href="/register/pemilik" class="btn daftar-pemilik w-100">Daftar sebagai Pemilik Kost</a>
                                </div>
                            </div>
                        </div>
                    </div>
